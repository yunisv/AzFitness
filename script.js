...
let countdownBox = document.querySelector(".countdownBox");
let secondBox = document.querySelector(".secondbox");
let windowInnerHeight = window.innerHeight;
firstbox.style.height = `${windowInnerHeight}px`;
countdownBox.style.height = `${windowInnerHeight/1.25}px`;
secondBox.style.height = `${windowInnerHeight/1.25}px`;
